  ...
  services: ServiceItem[] = [
    {
      icon: 'strategy',
      title: 'Стратегия',
      text: 'Разработка долгосрочгных стратегий развития отраслей промышленности.',
    },
    {
      icon: 'analize-promka',
      title: 'Анализ технологий',
      text: 'Анализ преспективных промышленных технологий.',
    },
    {
    ...
    },
    {
      ...
      text: 'Подготовка аналитических отчетов.',
    },
